            ...
            <ScrollToTop>
                ...
                >
                    <Routes>
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-fashion-three"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-fashion-seven"
                            }
                            element={<HomeFashionSeven />}
                        />
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-fashion-eight"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-furniture-two"
                            }
                            element={<HomeFurnitureTwo />}
                        />
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-furniture-three"
                            }
                            element={<HomeFurnitureThree />}
                        />
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-furniture-four"
                            }
                            element={<HomeFurnitureFour />}
                        />
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-furniture-five"
                            }
                            element={<HomeFurnitureFive />}
                        />
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-furniture-six"
                            }
                            element={<HomeFurnitureSix />}
                        />
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-furniture-seven"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-electronics-two"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-book-store-two"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-flower-shop-two"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-onepage-scroll"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/home-valentines-day"
                            }
              ...
              />*/}
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/product-tab-left/:id"
                            }
                        ...
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/product-sticky/:id"
                            }
                            element={<ProductSticky />}
                        />
                        <Route
                            path={
                                process.env.PUBLIC_URL + "/product-slider/:id"
                            }
