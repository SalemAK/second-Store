                        ...
                        <div className="col-lg-12 d-flex justify-content-center mb-4">
                            <div className="row">
                                <div className="col-lg-6 col-md-6 ">
                                    <h3 className="mt-2">Pickup / delivery :</h3>
                                </div>
                                <div className="col-lg-4 col-md-4 ">
                                    <div class="radio-input">
                                        <label>
                                            <input value="Delivery" name="value-radio" id="value-2" type="radio" checked={selectedOption === "Delivery"} onChange={handleOptionChange} />
                                            <span>Delivery</span>
                                        </label>
                                        <label>
                                            <input value="Pick up" name="value-radio" id="value-1" type="radio" checked={selectedOption === "Pick up"} onChange={handleOptionChange} />
                                            <span>Pick up</span>
                                        </label>
                                            ...
                                            <div className="your-order-product-info">
                                                ...
                                                <div className="your-order-bottom mb-2">
                                                    <ul>
                                                        ...
                                                        <li>{currency.currencySymbol + " " + taxAmount.toFixed(2)}</li>
                                                    </ul>
                                                </div>
                                                {selectedOption === "Delivery" ? (
                                                    <div className="your-order-bottom">
                                                        <ul>
                                                            ...
                                                            <li>{currency.currencySymbol + " " + shippingCost.toFixed(2)}</li>
                                                        </ul>
                                                    </div>
                                                ) : null}
                                                ...
                                                <div className="your-order-total">
                                                    <ul>
                                                        ...
                                                        <li>{currency.currencySymbol + " " + estimatedTotal.toFixed(2)}</li>
                                                    </ul>
                                                </div>
                                            </div>
